        ...
        <Center>
          <List>
            <Stack>
              ...
              <li>
                <ExternalLink href="https://frontend30.com/css-selectors-cheatsheet/">
                  CSS Cheat Sheet
                </ExternalLink>
                <p>
                  Can't remember how to select a child element? Quick reference
                  to CSS selectors.
                </p>
              </li>
              <li>
                <ExternalLink href="https://flukeout.github.io/">
                  CSS Diner
                </ExternalLink>
                <p>
                  Excellent way of practicing with CSS selectors! Can you get to
                  the last level?
                </p>
              </li>
              <li>
              ...
              <li>
                <ExternalLink href="https://diana-adrianne.com/purecss-francine/">
                  Francine
                </ExternalLink>
                <p>
